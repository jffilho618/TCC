...
ORIGEM_TREINO = os.path.join(SCRIPT_DIR, 'classificacao_crops', 'treino_kfold')
ORIGEM_TESTE_FINAL = os.path.join(SCRIPT_DIR, 'classificacao_crops', 'teste_final')
PASTA_TEMP_YOLO = os.path.join(SCRIPT_DIR, 'temp_yolo_data_balanceado')
ARQUIVO_CSV = os.path.join(SCRIPT_DIR, 'RESULTADOS_FINAIS_FASE1.5.csv')
MODELO_NOME = 'yolov8s-cls.pt' # Nano (leve). Use 'yolov8s-cls.pt' se quiser um pouco mais forte.
EPOCHS = 100
PATIENCE = 15
BATCH_SIZE = 32
# =================================================
