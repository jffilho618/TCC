...
PASTA_MODELOS = os.path.join(FASE2_DIR, 'modelos_fase2_ultimate')
...
def main():
    ...
    # 1. Buscar Modelos Treinados (aceita _fase2.pth e _fase2_ult.pth)
    ...
    for model_path in model_files:
        ...
        # Extrai nome do modelo (ex: resnet50_fase2_ult.pth -> resnet50)
        clean_name = filename.replace("_fase2_ult.pth", "").replace("_fase2.pth", "")
