...
CSV_CONTROLE = 'classificacao/dataset_kfold_controle.csv'
PASTA_BASE = 'classificacao'
ARQUIVO_RESULTADOS = 'RESULTADOS_FINAIS_FASE1.csv'
PASTA_MODELOS = 'modelos_salvos'  # <--- NOVA PASTA PARA GUARDAR OS PESOS
